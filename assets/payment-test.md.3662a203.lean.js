...
<script>
  ...
  initPayPalButton();
<\/script>
`)],-1),u=t('<h2 id="about-us" tabindex="-1">About Us <a class="header-anchor" href="#about-us" aria-label="Permalink to &quot;About Us&quot;">​</a></h2><div class="info custom-block"><p class="custom-block-title">About Us</p><p>Piperpiperpiper is a remote first job curation service. Our goal is to push forward the adoption of remote first and at a global scale.</p></div><details class="details custom-block"><summary>develop/debug</summary><p>version 230001</p></details>',3),g=JSON.parse('{"title":"the following paypal snippet is not working - delete","description":"","frontmatter":{"layout":"doc","search":false},"headers":[],"relativePath":"payment-test.md","filePath":"payment-test.md"}'),d={name:"payment-test.md"},b=Object.assign(d,{setup(h){return(m,f)=>{const n=s("ClientOnly");return a(),o("div",null,[p,r(n,null,{default:i(()=>[l,c]),_:1}),u])}}});export{g as __pageData,b as default};
